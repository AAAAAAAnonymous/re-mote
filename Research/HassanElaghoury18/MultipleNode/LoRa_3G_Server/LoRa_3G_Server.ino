...
//    sprintf(getstr,"GET /ollie/sendData?numData=2&type1=EC&id1=02&value1=%s&type2=DO&id2=02&value2=%s HTTP/1.1\r\nHost: <RETRACTED>\r\n\r\n", (char*)ECVal, (char*)DOVal);
                                            // GET request format for Thingspeak as well as the <RETRACTED> database

//    if (! fona.postData("<RETRACTED>",80,"HTTP",getstr))       // Uses new postData function from FONA library to send the corrrect AT commands and make http requests. 
