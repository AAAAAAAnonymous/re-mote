...
i18n
  ...
  .init({
    resources: {
      en: {
        translation: {
          ...
          "about": {
            ...
            "gwf": "Global Water Future is a joint effort by the University of Saskatchewan, University of Waterloo and <RETRACTED> University to manage water futures in the face of dramatically increasing risks.",
      ...
      fr: {
        translation: {
          ...
          "about": {
            ...
            "gwf": "Global Water Future est un effort conjoint de l'Université de la Saskatchewan, de l'Université de Waterloo et de l'Université <RETRACTED> pour gérer l'avenir de l'eau face à l'augmentation spectaculaire des risques.",
      ...
      //       "gwf": "Global Water Future ist eine gemeinsame Anstrengung der University of Saskatchewan, der University of Waterloo und der <RETRACTED> University, um die Wasserzukunft angesichts dramatisch zunehmender Risiken zu managen."    
      //     },
      //     "map": {
